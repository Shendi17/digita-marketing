<!-- ======= Footer ======= -->
<footer id="footer" class="bg-dark text-center py-4 mt-5 shadow-sm">
...
<!-- Suppression de l'inclusion du sidebar ici, car il est désormais dans le header -->

<!-- Scripts JS nécessaires (CDN uniquement) -->
