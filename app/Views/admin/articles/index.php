<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 fw-bold mb-1">
                <i class="bi bi-file-earmark-text-fill text-primary"></i> Gestion des articles
            </h1>
            <p class="text-muted mb-0"><?= $totalArticles ?> article(s) au total</p>
        </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3 col-6">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-3">
                    <div class="h4 fw-bold text-info mb-0"><?= number_format($stats['total_views']) ?></div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="/admin/articles" class="row g-2 align-items-end">
                <div class="col-md-4">
                    <label class="form-label small fw-semibold">Rechercher</label>
                    <input type="text" name="q" class="form-control" placeholder="Titre, contenu..." 
                    ...
                    <select name="category" class="form-select">
                        ...
                        <?php foreach ($categories as $cat): ?>
                            <option value="<?= $cat['id'] ?>" <?= ($filterCategory == $cat['id']) ? 'selected' : '' ?>>
                                <?= htmlspecialchars($cat['name']) ?> (<?= $cat['article_count'] ?>)
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
        ...
        <div class="card-body p-0">
            <?php if (empty($articles)): ?>
                <div class="text-center py-5">
                    ...
                    <a href="/admin/articles/new" class="btn btn-primary">
                        <i class="bi bi-plus-circle-fill"></i> Créer un article
                    </a>
                </div>
            <?php else: ?>
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light">
                            <tr>
                                <th class="ps-4" style="width: 40%">Titre</th>
                                <th>Catégorie</th>
                                <th>Statut</th>
                                <th>Vues</th>
                                <th>Date</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-muted">
                                            <i class="bi bi-eye"></i> <?= number_format($article['views'] ?? 0) ?>
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="/blog/<?= htmlspecialchars($article['slug']) ?>" 
        ...
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title">
                    <i class="bi bi-exclamation-triangle-fill text-danger"></i> Confirmer la suppression
                </h5>
